...
<html lang="en">
  ...
  <a class="btn btn-secondary mt-3 ms-3" href="/">Inicio</a>
    <main class="container">
        <h1>Excluir Aluno</h1>
        <form action="/aluno/excluido/<?= $resultado['id'] ?>" method="post">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input type="number" disabled value="<?=  $resultado['idade'] ?>" name="idade" class="form-control" required>
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col">
                    <p class="mt-4">Tem certeza que deseja excluir esse aluno?</p>
